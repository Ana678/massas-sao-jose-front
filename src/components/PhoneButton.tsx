...
export default function PhoneButton({ phone, size = "sm" }: PhoneButtonProps) {
    ...
    return (
        <a
            ...
            className={`inline-flex items-center gap-1.5 bg-primary/10 text-primary rounded-lg transition-colors hover:bg-primary/20 ${size === "md" ? "px-4 py-2.5 text-sm" : "px-3 py-1.5 text-xs"
                }`}
        >
